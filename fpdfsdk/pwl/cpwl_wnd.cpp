...
// static
const CFX_Color CPWL_Wnd::kDefaultBlackColor = CFX_Color::Gray(0.0f);

// static
const CFX_Color CPWL_Wnd::kDefaultWhiteColor = CFX_Color::Gray(1.0f);
...
CFX_Color CPWL_Wnd::GetBorderLeftTopColor(BorderStyle nBorderStyle) const {
  switch (nBorderStyle) {
    case BorderStyle::kBeveled:
      return CFX_Color::Gray(1.0f);
    case BorderStyle::kInset:
      return CFX_Color::Gray(0.5f);
    default:
      return CFX_Color();
  }
}
