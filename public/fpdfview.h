...
typedef struct FPDF_LIBRARY_CONFIG_ {
  ...
  // Boolean set to whether brotli (for the experimental PDF 2.0 /BrotliDecode)
  // filter is enabled. For setting the bool to true to have an effect, PDFium
  // must be built with |PDF_ENABLE_BROTLI|.
