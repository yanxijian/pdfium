...
class CFX_CTTNameTable {
 public:
  ...
  CFX_CTTNameTable(const CFX_CTTNameTable&);
  CFX_CTTNameTable& operator=(const CFX_CTTNameTable&);
  CFX_CTTNameTable(CFX_CTTNameTable&&);
  CFX_CTTNameTable& operator=(CFX_CTTNameTable&&);
  ~CFX_CTTNameTable();
