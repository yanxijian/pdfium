...
CFX_CTTNameTable::CFX_CTTNameTable(const CFX_CTTNameTable&) = default;
CFX_CTTNameTable& CFX_CTTNameTable::operator=(const CFX_CTTNameTable&) =
    default;

CFX_CTTNameTable::CFX_CTTNameTable(CFX_CTTNameTable&&) = default;
CFX_CTTNameTable& CFX_CTTNameTable::operator=(CFX_CTTNameTable&&) = default;
