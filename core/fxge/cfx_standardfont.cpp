...
std::optional<CFX_StandardFont::ID>
CFX_StandardFont::CanonicalizeStandardFontName(ByteString* name) {
  ...
  *name = kBase14FontNames[found->index_];
  return found->index_;
}
...
std::optional<CFX_StandardFont::ID> CFX_StandardFont::GetStandardFontID(
