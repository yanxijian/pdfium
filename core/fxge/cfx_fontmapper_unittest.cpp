...
TEST(CFXFontMapperTest, IsStandardFontName) {
  EXPECT_TRUE(FX_IsStandardFontName("Courier"));
  EXPECT_TRUE(FX_IsStandardFontName("Courier-Bold"));
  EXPECT_TRUE(FX_IsStandardFontName("Courier-BoldOblique"));
  EXPECT_TRUE(FX_IsStandardFontName("Courier-Oblique"));
  EXPECT_TRUE(FX_IsStandardFontName("Helvetica"));
  EXPECT_TRUE(FX_IsStandardFontName("Helvetica-Bold"));
  EXPECT_TRUE(FX_IsStandardFontName("Helvetica-BoldOblique"));
  EXPECT_TRUE(FX_IsStandardFontName("Helvetica-Oblique"));
  EXPECT_TRUE(FX_IsStandardFontName("Times-Roman"));
  EXPECT_TRUE(FX_IsStandardFontName("Times-Bold"));
  EXPECT_TRUE(FX_IsStandardFontName("Times-BoldItalic"));
  EXPECT_TRUE(FX_IsStandardFontName("Times-Italic"));
  EXPECT_TRUE(FX_IsStandardFontName("Symbol"));
  EXPECT_TRUE(FX_IsStandardFontName("ZapfDingbats"));

  EXPECT_FALSE(FX_IsStandardFontName("Courie"));
  EXPECT_FALSE(FX_IsStandardFontName("Courier-"));
  EXPECT_FALSE(FX_IsStandardFontName("Helvetica+Bold"));
  EXPECT_FALSE(FX_IsStandardFontName("YapfDingbats"));
}
