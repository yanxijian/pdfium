...
static_assert(static_cast<int>(fxge::StandardFont::kLast) + 1 ==
                  fxge::kNumStandardFonts,
...
constexpr std::array<const char*, kNumStandardFonts> kBase14FontNames = {{
    "Courier",
    "Courier-Bold",
    "Courier-BoldOblique",
    "Courier-Oblique",
...
constexpr std::array<pdfium::span<const uint8_t>, kNumStandardFonts>
    kFoxitFonts = {{
        kFoxitFixedFontData,
