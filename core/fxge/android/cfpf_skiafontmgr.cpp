...
static_assert(ConstexprHashNormalizeFontName("STSong") == 0xcad5eaf6,
              "STSong hash mismatch");
static_assert(ConstexprHashNormalizeFontName("Cursive") == 0x432c41c5,
              "Cursive hash mismatch");
static_assert(ConstexprHashNormalizeFontName("Fantasy") == 0xbf85ff26,
              "Fantasy hash mismatch");
static_assert(ConstexprHashNormalizeFontName("Sanserif") == 0x779ce19d,
              "Sanserif hash mismatch");
static_assert(ConstexprHashNormalizeFontName("Goudy") == 0x05dfade2,
              "Goudy hash mismatch");
