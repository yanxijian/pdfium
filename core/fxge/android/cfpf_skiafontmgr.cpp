...
// Map from OS/2 table ulCodePageRange1 bits (0-31) to FX_SupportedCharsetFlag.
...
constexpr auto kFPFSkiaFontFXSupportedCharsetFlags =
    std::to_array<const FX_SupportedCharsetFlag>({
        FX_SupportedCharsetFlag::kANSI,                   // 0 (Latin 1)
        FX_SupportedCharsetFlag::kMSWin_EasternEuropean,  // 1 (Latin 2)
        FX_SupportedCharsetFlag::kMSWin_Cyrillic,         // 2 (Cyrillic)
        FX_SupportedCharsetFlag::kMSWin_Greek,            // 3 (Greek)
        FX_SupportedCharsetFlag::kMSWin_Turkish,          // 4 (Turkish)
        FX_SupportedCharsetFlag::kMSWin_Hebrew,           // 5 (Hebrew)
        FX_SupportedCharsetFlag::kMSWin_Arabic,           // 6 (Arabic)
        FX_SupportedCharsetFlag::kMSWin_Baltic,           // 7 (Baltic)
        FX_SupportedCharsetFlag::kMSWin_Vietnamese,       // 8 (Vietnamese)
        FX_SupportedCharsetFlag::kNone,                   // 9 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 10 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 11 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 12 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 13 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 14 (Alt ANSI)
        FX_SupportedCharsetFlag::kNone,                   // 15 (Alt ANSI)
        FX_SupportedCharsetFlag::kThai,                   // 16 (Thai)
        FX_SupportedCharsetFlag::kShiftJIS,               // 17 (JIS/Japan)
        FX_SupportedCharsetFlag::kChineseSimplified,      // 18 (CN Simple)
        FX_SupportedCharsetFlag::kHangul,                 // 19 (Korean Wansung)
        FX_SupportedCharsetFlag::kChineseTraditional,     // 20 (CN Trad)
        FX_SupportedCharsetFlag::kJohab,                  // 21 (Korean Johab)
        FX_SupportedCharsetFlag::kNone,                   // 22 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 23 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 24 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 25 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 26 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 27 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 28 (Alt ANSI/OEM)
        FX_SupportedCharsetFlag::kNone,                   // 29 (Mac US Roman)
        FX_SupportedCharsetFlag::kOEM,                    // 30 (OEM)
        FX_SupportedCharsetFlag::kSymbol,                 // 31 (Symbol)
    });

Mask<FX_SupportedCharsetFlag> SkiaGetFaceCharsets(uint32_t code_range) {
  static_assert(
      static_cast<uint32_t>(FX_SupportedCharsetFlag::kNone) == 0,
      "FX_SupportedCharsetFlag::kNone must be 0 for ORing to be a no-op");
