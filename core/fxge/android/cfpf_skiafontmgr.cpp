...
constexpr auto kFPFSkiaFontFXCharsetFlags =
    std::to_array<const FX_CharsetFlag>({
        FX_CharsetFlag::kANSI,                   // 0
        FX_CharsetFlag::kMSWin_EasternEuropean,  // 1
        FX_CharsetFlag::kMSWin_Cyrillic,         // 2
        FX_CharsetFlag::kMSWin_Greek,            // 3
        FX_CharsetFlag::kMSWin_Turkish,          // 4
        FX_CharsetFlag::kMSWin_Hebrew,           // 5
        FX_CharsetFlag::kMSWin_Arabic,           // 6
        FX_CharsetFlag::kMSWin_Baltic,           // 7
        FX_CharsetFlag::kNone,                   // 8
        FX_CharsetFlag::kNone,                   // 9
        FX_CharsetFlag::kNone,                   // 10
        FX_CharsetFlag::kNone,                   // 11
        FX_CharsetFlag::kNone,                   // 12
        FX_CharsetFlag::kNone,                   // 13
        FX_CharsetFlag::kNone,                   // 14
        FX_CharsetFlag::kNone,                   // 15
        FX_CharsetFlag::kThai,                   // 16
        FX_CharsetFlag::kShiftJIS,               // 17
        FX_CharsetFlag::kChineseSimplified,      // 18
        FX_CharsetFlag::kHangul,                 // 19
        FX_CharsetFlag::kChineseTraditional,     // 20
        FX_CharsetFlag::kJohab,                  // 21
        FX_CharsetFlag::kNone,                   // 22
        FX_CharsetFlag::kNone,                   // 23
        FX_CharsetFlag::kNone,                   // 24
        FX_CharsetFlag::kNone,                   // 25
        FX_CharsetFlag::kNone,                   // 26
        FX_CharsetFlag::kNone,                   // 27
        FX_CharsetFlag::kNone,                   // 28
        FX_CharsetFlag::kNone,                   // 29
        FX_CharsetFlag::kOEM,                    // 30
        FX_CharsetFlag::kSymbol,                 // 31
    });
...
Mask<FX_CharsetFlag> SkiaGetFaceCharsets(uint32_t code_range) {
  ...
  for (int32_t i = 0; i < 32; i++) {
    if (code_range & (1 << i)) {
      if (kFPFSkiaFontFXCharsetFlags[i] != FX_CharsetFlag::kNone) {
...
CFPF_SkiaFont* CFPF_SkiaFontMgr::CreateFont(ByteStringView family_name,
  ...
  for (const std::unique_ptr<Entry>& font : pdfium::Reversed(font_faces_)) {
    if (charset != FX_Charset::kDefault) {
      FX_CharsetFlag flag = FX_GetCharsetFlag(charset);
