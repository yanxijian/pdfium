...
class CFXFolderFontInfoTest : public ::testing::Test {
 public:
  CFXFolderFontInfoTest() {
    AddDummyFont(kArial, FX_SupportedCharsetFlag::kANSI);
    AddDummyFont(kCourierNew, FX_SupportedCharsetFlag::kANSI);
    AddDummyFont(kTimesNewRoman, FX_SupportedCharsetFlag::kNone);
    AddDummyFont(kBookshelfSymbol7, FX_SupportedCharsetFlag::kSymbol);
    AddDummyFont(kSymbol, FX_SupportedCharsetFlag::kSymbol);
    AddDummyFont(kTofuBold, FX_SupportedCharsetFlag::kSymbol);
    AddDummyFont(kLatoUltraBold, FX_SupportedCharsetFlag::kANSI);
    AddDummyFont(kOxygenSansSansBold, FX_SupportedCharsetFlag::kANSI);
    AddDummyFont(kComicSansMS, FX_SupportedCharsetFlag::kANSI);
  }
 ...
 private:
  void AddDummyFont(const char* font_name, FX_SupportedCharsetFlag charset) {
