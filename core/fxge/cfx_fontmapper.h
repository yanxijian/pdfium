...
class CFX_FontMapper {
 public:
  using StandardFont = fxge::StandardFont;
  static constexpr int kNumStandardFonts = fxge::kNumStandardFonts;
  static constexpr StandardFont kCourier = StandardFont::kCourier;
  static constexpr StandardFont kCourierBold = StandardFont::kCourierBold;
  static constexpr StandardFont kCourierBoldOblique =
      StandardFont::kCourierBoldOblique;
  static constexpr StandardFont kCourierOblique = StandardFont::kCourierOblique;
  static constexpr StandardFont kHelvetica = StandardFont::kHelvetica;
  static constexpr StandardFont kHelveticaBold = StandardFont::kHelveticaBold;
  static constexpr StandardFont kHelveticaBoldOblique =
      StandardFont::kHelveticaBoldOblique;
  static constexpr StandardFont kHelveticaOblique =
      StandardFont::kHelveticaOblique;
  static constexpr StandardFont kTimes = StandardFont::kTimes;
  static constexpr StandardFont kTimesBold = StandardFont::kTimesBold;
  static constexpr StandardFont kTimesBoldOblique =
      StandardFont::kTimesBoldOblique;
  static constexpr StandardFont kTimesOblique = StandardFont::kTimesOblique;
  static constexpr StandardFont kSymbol = StandardFont::kSymbol;
  static constexpr StandardFont kDingbats = StandardFont::kDingbats;
  static constexpr StandardFont kLast = StandardFont::kLast;
  ...
  static std::optional<StandardFont> GetStandardFontName(ByteString* name) {
    return fxge::GetStandardFontName(name);
  }
  static bool IsStandardFontName(const ByteString& name) {
    return fxge::IsStandardFontName(name);
  }
  static bool IsSymbolicFont(StandardFont font) {
    return fxge::IsSymbolicFont(font);
  }
  static bool IsFixedFont(StandardFont font) { return fxge::IsFixedFont(font); }
