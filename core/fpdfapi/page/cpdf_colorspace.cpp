...
void CPDF_ICCBasedCS::TranslateImageLine(pdfium::span<uint8_t> dest_span,
  ...
  // nMaxColors can't overflow as the variable is only used in the case of
  // nComponents being less than 3. This leads to a maximum possible value of
  // 256^3, which is less than INT32_MAX, although FX_SAFE_INT32 is used to be
  // extra safe.
