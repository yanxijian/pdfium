...
TEST_F(CPDFPageImageCacheTest, RenderReducedDctThenFullSize) {
  ...
  EXPECT_LT(bitmap_small->GetWidth(), 400);
  ...
  EXPECT_GT(bitmap_large->GetWidth(), bitmap_small->GetWidth());
  EXPECT_GT(bitmap_large->GetHeight(), bitmap_small->GetHeight());
