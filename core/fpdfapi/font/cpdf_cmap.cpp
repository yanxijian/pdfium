...
constexpr PredefinedCMap kPredefinedCMaps[] = {
    {"GB-EUC", kGB1, CIDCoding::kGB, CPDF_CMap::MixedTwoBytes, {{0xa1, 0xfe}}},
    {"GBpc-EUC",
     kGB1,
     CIDCoding::kGB,
     CPDF_CMap::MixedTwoBytes,
     {{0xa1, 0xfc}}},
    {"GBK-EUC", kGB1, CIDCoding::kGB, CPDF_CMap::MixedTwoBytes, {{0x81, 0xfe}}},
    {"GBKp-EUC",
     kGB1,
     CIDCoding::kGB,
     CPDF_CMap::MixedTwoBytes,
    ...
    {"GBK2K-EUC",
     ...
     CPDF_CMap::MixedTwoBytes,
     {{0x81, 0xfe}}},
    {"GBK2K", kGB1, CIDCoding::kGB, CPDF_CMap::MixedTwoBytes, {{0x81, 0xfe}}},
    {"UniGB-UCS2", kGB1, CIDCoding::kUCS2, CPDF_CMap::TwoBytes, {}},
    {"UniGB-UTF16", kGB1, CIDCoding::kUTF16, CPDF_CMap::TwoBytes, {}},
    {"B5pc", kCNS1, CIDCoding::kBIG5, CPDF_CMap::MixedTwoBytes, {{0xa1, 0xfc}}},
    {"HKscs-B5",
     kCNS1,
     CIDCoding::kBIG5,
     CPDF_CMap::MixedTwoBytes,
    ...
    {"ETenms-B5",
     ...
     CPDF_CMap::MixedTwoBytes,
     {{0xa1, 0xfe}}},
    {"UniCNS-UCS2", kCNS1, CIDCoding::kUCS2, CPDF_CMap::TwoBytes, {}},
    {"UniCNS-UTF16", kCNS1, CIDCoding::kUTF16, CPDF_CMap::TwoBytes, {}},
    {"83pv-RKSJ",
     kJapan1,
     CIDCoding::kJIS,
     CPDF_CMap::MixedTwoBytes,
    ...
    {"EUC",
     ...
     CPDF_CMap::MixedTwoBytes,
     {{0x8e, 0x8e}, {0xa1, 0xfe}}},
    {"H", kJapan1, CIDCoding::kJIS, CPDF_CMap::TwoBytes, {{0x21, 0x7e}}},
    {"V", kJapan1, CIDCoding::kJIS, CPDF_CMap::TwoBytes, {{0x21, 0x7e}}},
    {"Ext-RKSJ",
     kJapan1,
     CIDCoding::kJIS,
     CPDF_CMap::MixedTwoBytes,
     {{0x81, 0x9f}, {0xe0, 0xfc}}},
    {"UniJIS-UCS2", kJapan1, CIDCoding::kUCS2, CPDF_CMap::TwoBytes, {}},
    {"UniJIS-UCS2-HW", kJapan1, CIDCoding::kUCS2, CPDF_CMap::TwoBytes, {}},
    {"UniJIS-UTF16", kJapan1, CIDCoding::kUTF16, CPDF_CMap::TwoBytes, {}},
    {"KSC-EUC",
     kKorea1,
     CIDCoding::kKOREA,
     CPDF_CMap::MixedTwoBytes,
    ...
    {"KSCpc-EUC",
     ...
     CPDF_CMap::MixedTwoBytes,
     {{0xa1, 0xfd}}},
    {"UniKS-UCS2", kKorea1, CIDCoding::kUCS2, CPDF_CMap::TwoBytes, {}},
    {"UniKS-UTF16", kKorea1, CIDCoding::kUTF16, CPDF_CMap::TwoBytes, {}},
};
