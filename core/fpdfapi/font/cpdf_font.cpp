...
bool CPDF_Font::ShouldApplyGlyphSpacingHeuristic(
  ...
  std::optional<CFX_StandardFont::ID> standard_font_name =
      CFX_StandardFont::CanonicalizeStandardFontName(&base_font_name);
...
RetainPtr<CPDF_Font> CPDF_Font::GetStockFont(CPDF_Document* doc,
  ...
  std::optional<CFX_StandardFont::ID> font_id =
      CFX_StandardFont::CanonicalizeStandardFontName(&fontname);
