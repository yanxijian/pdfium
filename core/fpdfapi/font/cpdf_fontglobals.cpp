...
void CPDF_FontGlobals::LoadEmbeddedGB1CMaps() {
  SetEmbeddedCharset(kGB1, fxcmap::kGB1_cmaps);
  SetEmbeddedToUnicode(kGB1, fxcmap::kGB1CID2Unicode_5);
}

void CPDF_FontGlobals::LoadEmbeddedCNS1CMaps() {
  SetEmbeddedCharset(kCNS1, fxcmap::kCNS1_cmaps);
  SetEmbeddedToUnicode(kCNS1, fxcmap::kCNS1CID2Unicode_5);
}

void CPDF_FontGlobals::LoadEmbeddedJapan1CMaps() {
  SetEmbeddedCharset(kJapan1, fxcmap::kJapan1_cmaps);
  SetEmbeddedToUnicode(kJapan1, fxcmap::kJapan1CID2Unicode_4);
}

void CPDF_FontGlobals::LoadEmbeddedKorea1CMaps() {
  SetEmbeddedCharset(kKorea1, fxcmap::kKorea1_cmaps);
  SetEmbeddedToUnicode(kKorea1, fxcmap::kKorea1CID2Unicode_2);
}
