...
void CFWL_Widget::ModifyStyles(Mask<WidgetStyle> styles_added,
                               Mask<WidgetStyle> styles_removed) {
  properties_.styles_ &= ~styles_removed;
  properties_.styles_ |= styles_added;
}
...
bool CFWL_Widget::IsOverLapper() const {
  return (properties_.styles_ & WidgetStyle::kWindowTypeMask) ==
