...
// Sentinel nibble value meaning "no BidiClass".
constexpr BidiClass kBidiClassNone = static_cast<BidiClass>(kNibbleMask);
...
enum FX_BIDIWEAKACTION : uint16_t {
  ...
  FX_BWAxxN = PACK_NIBBLES(kBidiClassNone, BidiClass::kON),
  FX_BWAxxE = PACK_NIBBLES(kBidiClassNone, BidiClass::kEN),
  FX_BWAxxA = PACK_NIBBLES(kBidiClassNone, BidiClass::kAN),
  FX_BWAxxR = PACK_NIBBLES(kBidiClassNone, BidiClass::kR),
  FX_BWAxxL = PACK_NIBBLES(kBidiClassNone, BidiClass::kL),
  FX_BWANxx = PACK_NIBBLES(BidiClass::kON, kBidiClassNone),
  FX_BWAAxx = PACK_NIBBLES(BidiClass::kAN, kBidiClassNone),
  FX_BWAExE = PACK_NIBBLES(BidiClass::kEN, BidiClass::kEN),
  FX_BWANIx = 0x100 + PACK_NIBBLES(BidiClass::kON, kBidiClassNone),
  ...
  FX_BWAxIL = 0x100 + PACK_NIBBLES(kBidiClassNone, BidiClass::kL),
  FX_BWAAxR = PACK_NIBBLES(BidiClass::kAN, BidiClass::kR),
  FX_BWALxx = PACK_NIBBLES(BidiClass::kL, kBidiClassNone),
};
