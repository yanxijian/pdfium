...
class CXFA_ContentLayoutItem final : public CXFA_LayoutItem {
 public:
  ...
  CXFA_FFWidget* GetFFWidget() const { return ffwidget_; }

  CXFA_ContentLayoutItem* GetFirst();
  CXFA_ContentLayoutItem* GetLast();
  CXFA_ContentLayoutItem* GetPrev() { return prev_; }
  const CXFA_ContentLayoutItem* GetPrev() const { return prev_; }
  CXFA_ContentLayoutItem* GetNext() { return next_; }
  const CXFA_ContentLayoutItem* GetNext() const { return next_; }
  ...
  void SetStatusBits(Mask<XFA_WidgetStatus> val) const { status_ |= val; }
  void ClearStatusBits(Mask<XFA_WidgetStatus> val) const { status_ &= ~val; }
...
inline CXFA_FFWidget* GetFFWidget(const CXFA_ContentLayoutItem* item) {
